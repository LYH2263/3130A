...
var (
	...
	ErrExamConfigNotFound      = errors.New("exam config not found")
	ErrExamConfigNameEmpty     = errors.New("exam config name cannot be empty")
	ErrInvalidDuration         = errors.New("duration must be greater than 0")
	ErrEarlySubmitNotAllowed   = errors.New("early submission is not allowed")
	ErrDefaultExamConfigExists = errors.New("default exam config already exists")
)
